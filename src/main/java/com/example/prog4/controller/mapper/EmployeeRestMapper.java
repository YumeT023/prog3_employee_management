...
public class EmployeeRestMapper {
    ...
    public com.example.prog4.model.core.entity.management.Employee toDomain(Employee employee) {
        try {
            ...
            List<Phone> phones = employee.getPhones().stream().map((com.example.prog4.model.core.dto.management.Phone fromView) -> phoneMapper.toDomain(fromView, employee.getId())).toList();

            com.example.prog4.model.core.entity.management.Employee domainEmployee = com.example.prog4.model.core.entity.management.Employee.builder()
                    .id(employee.getId())
    ...
    public Employee toView(com.example.prog4.model.core.entity.management.Employee employee) {
